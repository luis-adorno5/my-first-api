...
public class GreetingControllerTest {
    ...
    @Test
    @DisplayName("Get /greeting?name=Tariq - success")
    public void greetingTest02() throws Exception {

        mockMvc.perform(MockMvcRequestBuilders.get("/greeting?name=Tariq"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.jsonPath("$.content", Is.is("Hello, Tariq!")));
    }
